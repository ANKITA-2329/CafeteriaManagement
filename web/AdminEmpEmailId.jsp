...
<html>
    ...
    <body>
        ...
        <form action = "./ForgetEAPasswordServlet" method ="Post" onsubmit ="return verifyPassword()">
            <div class ="container form-outline border">
                ...
                <div class = "container form-outline mb-4">
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="r1" value = "admin" id="r1" checked>
