...
<html>
    ...
    <body>
        <jsp:include page = "empPage.jsp"/><br><br>
            ...
            <div class = "container form-outline mb-4">
                ...
                <div class = "container form-outline mb-4">
                    <div class="form-check">
                        ...
                        <div class="form-check">
                        <input class="form-check-input" type="radio" name="r1" value = "In Kitchen" id="r2">
                        <label class="form-check-label" for="r2">
                            In Kitchen
                        </label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="r1" value = "Prepared" id="r3">
                        <label class="form-check-label" for="r3">
                            Prepared
                        </label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="r1" value = "Completed" id="r4">
